...
#
# Find the greatest product of four adjacent numbers in the grid in any
# direction.
#
...
def main():
    # Turn the grid into a 2-dim array.
    grid = [list(int(n) for n in s.split()) for s in GRID]

    # Store all the possible sequences of adjacent numbers.
    sequences = []

    # We will iterate through each position in the grid and calculate the
    ...
    print(max(reduce(operator.mul, s) for s in sequences))
